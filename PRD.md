...
- **집 렌트** (가장 먼저 진행)
  ...
  - Redfin, Zillow로 한국에서 사전 시세 확인
  - 계약 시 필요 서류 준비: SSN, 급여명세서, 은행 잔고증명
...
- **은행 계좌 개설**
  ...
  - 최소 잔고: 약 $2,000 (Chase 기준)

- **유틸리티 신청**
  - 집 입주 날짜 정해지면 신청
  - 신청 항목: 수도, 전기(SoCal Edison), 가스(SoCal Gas), 인터넷(Spectrum/AT&T/Verizon), 쓰레기 수거(EDCO)
  - 유틸리티 청구서는 거주증명으로 활용
...
- **운전면허 취득**
  ...
  - DMV 온라인 계정 생성 및 정보 기입
  - 필기 시험: 한국어 선택 가능, 유튜브 공부 추천
  - 필요 서류: 여권, SSN, 거주지 증명서류 2개 이상, I-94
  - 필기 시험 통과 시 Learner's Permit (임시 면허) 발급
  - 실기 시험: DMV 홈페이지에서 예약, 자차로 시험 응시

- **차량 구매/리스**

  - 신차/중고차(Carmax) 구매 또는 리스
  - 리스 기간: 3년
...
- **자동차 보험**
  ...
  - 차량 구매/리스와 동시에 진행
  - 보험사: Allstate, State Farm, Farmers Insurance, Progressive, GEICO 등
  - 초기 보험료: 월 약 $350
