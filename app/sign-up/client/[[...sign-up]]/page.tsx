...
import { ClientSignUpContent } from "./client-sign-up-content";

/**
 * @file app/sign-up/client/[[...sign-up]]/page.tsx
 * @description 클라이언트 회원가입 페이지
 *
...
export default function ClientSignUpPage() {
  ...
  if (maintenanceMode) {
    console.log(
      "[ClientSignUpPage] Maintenance mode active, redirecting to /maintenance",
    );
