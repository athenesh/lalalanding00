-- Storage RLS 정책 업데이트: 권한 부여된 사용자가 클라이언트의 파일에 접근 가능하도록
-- 파일 경로: {clerk_user_id}/checklist/{item_id}/{filename}
-- 권한 부여된 사용자는 클라이언트의 clerk_user_id 폴더에 접근 가능
...
-- ============================================
-- INSERT 정책: 본인 폴더 또는 권한 부여된 클라이언트 폴더에 업로드 가능
-- ============================================
...
-- ============================================
-- SELECT 정책: 본인 폴더 또는 권한 부여된 클라이언트 폴더의 파일 조회 가능
-- ============================================
...
-- ============================================
-- DELETE 정책: 본인 폴더 또는 권한 부여된 클라이언트 폴더의 파일 삭제 가능
-- ============================================
...
-- ============================================
-- UPDATE 정책: 본인 폴더 또는 권한 부여된 클라이언트 폴더의 파일 업데이트 가능
-- ============================================
